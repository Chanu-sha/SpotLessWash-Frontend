...
export default function AboutUs() {
  return (
    <div className="bg-gradient-to-br mb-10 from-green-50 to-emerald-50">
      <Header />
      <div className="min-h-screen flex flex-col gap-10 py-8 px-4 md:px-6 lg:px-10 max-w-7xl mx-auto">
        {/* ---------------- HERO SECTION ---------------- */}
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="bg-gradient-to-r from-green-600 to-emerald-500 p-6 text-center lg:text-left lg:flex lg:items-center lg:justify-between">
            <div>
              <h1 className="text-3xl lg:text-4xl font-bold text-white">
                About <span className="italic">Spot Less Wash</span>
              </h1>
              <p className="text-emerald-100 mt-2 lg:text-lg">
                Odisha's trusted laundry platform connecting you with verified
                professionals
              </p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-green-500">
          <div className="p-6 lg:p-8 flex flex-col lg:flex-row lg:items-start lg:gap-8">
            ...
            <div className="text-gray-600">
              <p className="mb-3">
                Spot Less Wash is Odisha's leading laundry platform that
                connects busy families with verified laundry professionals in
                their neighborhood. We make quality laundry services accessible,
                affordable, and convenient.
              </p>
              <p>
                Just like an e-commerce platform connects you with businesses,
                we connect you with trusted laundry experts who pick up, clean,
                and deliver your clothes with care.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="p-5 flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Choose your preferred laundry partner and schedule pickup
                    instantly.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-blue-400 hover:shadow-lg transition-shadow">
              <div className="p-5 flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Our delivery partners collect clothes and connect you with
                    verified vendors.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-cyan-400 hover:shadow-lg transition-shadow">
              <div className="p-5 flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Trusted laundry professionals clean your clothes with
                    premium care.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-indigo-400 hover:shadow-lg transition-shadow">
              <div className="p-5 flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Fresh, clean clothes delivered back to your doorstep on
                    time.
                  </p>
                </div>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-orange-500">
          <div className="p-6 lg:p-8 flex flex-col lg:flex-row lg:items-start lg:gap-6">
            <div className="flex items-center mb-4 lg:mb-0">
            ...
            <p className="text-gray-600">
              To revolutionize laundry services in Odisha by creating a trusted
              platform that empowers local laundry businesses while providing
              families with convenient, quality cleaning services at their
              fingertips.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-purple-500">
          <div className="p-6 lg:p-8">
            ...
            <p className="text-gray-600 mb-3">
              Our platform is currently connecting customers with laundry
              partners in:
            </p>
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-amber-500">
          <div className="p-6 lg:p-8">
            ...
            <ul className="space-y-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              <li className="flex items-start">
                <span className="flex-shrink-0 bg-green-100 p-1 rounded-full mr-3">
                  <MdVerified className="h-4 w-4 text-green-600" />
                </span>
                <span className="text-gray-600">
                  Only verified & trusted laundry professionals
                </span>
              </li>
              <li className="flex items-start">
                <span className="flex-shrink-0 bg-green-100 p-1 rounded-full mr-3">
                ...
                <span className="text-gray-600">
                  100% quality assurance & damage protection
                </span>
              </li>
              <li className="flex items-start">
                <span className="flex-shrink-0 bg-green-100 p-1 rounded-full mr-3">
                ...
                <span className="text-gray-600">
                  Real-time tracking & guaranteed timely delivery
                </span>
              </li>
              <li className="flex items-start">
                <span className="flex-shrink-0 bg-green-100 p-1 rounded-full mr-3">
                ...
                <span className="text-gray-600">
                  24/7 customer support in local language
                </span>
              </li>
              <li className="flex items-start">
                <span className="flex-shrink-0 bg-green-100 p-1 rounded-full mr-3">
                ...
                <span className="text-gray-600">
                  Supporting local businesses & creating jobs
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 p-6 lg:p-10">
        ...
        {/* ---------------- TESTIMONIAL ---------------- */}
        <div className="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-rose-500 text-center p-6 lg:p-10 max-w-3xl mx-auto">
          <div className="flex justify-center mb-3 text-amber-400">
            {[...Array(5)].map((_, i) => (
              <FaStar key={i} />
            ))}
          </div>
          <blockquote className="text-gray-600 italic text-lg lg:text-xl">
            "Platform bahut reliable hai - har bar same quality aur time pe
            delivery!"
          </blockquote>
